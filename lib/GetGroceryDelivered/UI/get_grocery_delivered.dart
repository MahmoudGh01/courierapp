...
import 'package:courier_app/GetGroceryDelivered/UI/groceryconfirm_info.dart';
...
class GetGroceryDeliveredPage extends StatelessWidget {
  const GetGroceryDeliveredPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const GetGroceryDeliveredBody();
  }
}

class GetGroceryDeliveredBody extends StatefulWidget {
  const GetGroceryDeliveredBody({super.key});

  @override
  State<GetGroceryDeliveredBody> createState() =>
