...
const String apiKey = 'AIzaSyAThmEEZoKYYftRnoM18-MMUQuYEPucJXY';
...
const CameraPosition kGooglePlex = CameraPosition(
  target: LatLng(37.42296133580664, -122.080749655962),
  zoom: 14.4746,
);
...
class MapUtils {
  static getMarkerPic() async {
    ...
    markerss.add(await createBitmapDescriptorFromImage('images/ic_pickup.png', ''));
    markerss.add(await createBitmapDescriptorFromImage('images/ic_drop.png', ''));
